...
void base64_stream_encode_init (void);
...
void base64_stream_encode (const char *const src, size_t srclen, char *const out, size_t *const outlen);
 ...
 * often be zero). */
void base64_stream_encode_final (char *const out, size_t *outlen);
...
void base64_stream_decode_init (void);
...
int base64_stream_decode (const char *const src, size_t srclen, char *const out, size_t *const outlen);
