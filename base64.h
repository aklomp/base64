...
void base64_stream_encode (const char *const src, size_t srclen, char *const out, size_t *outlen);
...
int base64_stream_decode (const char *const src, size_t srclen, char *const out, size_t *outlen);
